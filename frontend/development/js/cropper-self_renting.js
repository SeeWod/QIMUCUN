...
function cropperStart(str2){
	...
	cropperView.style.display = "flex";
}
function cropperEnd(){
  //console.log("cropperÊý¾Ý"+cropper.getData(true).width);
	var canvas_ = cropper.getCroppedCanvas({width:1200,height:600,fillColor: '#ffff',imageSmoothingEnabled:false,imageSmoothingQuality:'high',});
